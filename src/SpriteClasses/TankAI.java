...
public class TankAI extends Sprite {
    ...
    private void imageSetUp() {
        if ("basic".equals(this.type)) {
            loadImage("src/image/tank_basic_up.png");
            getImageDimensions();
            this.imageUp = "src/image/tank_basic_up.png";
            this.imageDown = "src/image/tank_basic_down.png";
            this.imageLeft = "src/image/tank_basic_left.png";
            this.imageRight = "src/image/tank_basic_right.png";
        } else if ("armor".equals(this.type)) {
            loadImage("src/image/tank_armor_up.png");
            getImageDimensions();
            this.imageUp = "src/image/tank_armor_up.png";
            this.imageDown = "src/image/tank_armor_down.png";
            this.imageLeft = "src/image/tank_armor_left.png";
            this.imageRight = "src/image/tank_armor_right.png";
        } else if ("power".equals(this.type)) {
            loadImage("src/image/tank_power_up.png");
            getImageDimensions();
            this.imageUp = "src/image/tank_power_up.png";
            this.imageDown = "src/image/tank_power_down.png";
            this.imageLeft = "src/image/tank_power_left.png";
            this.imageRight = "src/image/tank_power_right.png";
        } else if ("fast".equals(this.type)) {
            loadImage("src/image/tank_fast_up.png");
            getImageDimensions();
            this.imageUp = "src/image/tank_fast_up.png";
            this.imageDown = "src/image/tank_fast_down.png";
            this.imageLeft = "src/image/tank_fast_left.png";
            this.imageRight = "src/image/tank_fast_right.png";
        }
    }
