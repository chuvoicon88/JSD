...
public class SoundUtility {
    ...
    public static void initialize() {
        ...
        try {
            ...
            File bTse = new File("src/sound/bullet_hit_1.wav");
            ...
            File ex2 = new File("src/sound/explosion_2.wav");
            ...
            File stageStart = new File("src/sound/stage_start.wav");
            ...
            File powerUpPickup = new File("src/sound/powerup_pick.wav");
            ...
            File game_over = new File("src/sound/game_over.wav");
            ...
            File statistics = new File("src/sound/statistics_1.wav");
